...
namespace ProyectoFinal.Clases
{
    ...
    public  class OptionBox
    {
        ...
        private OptionBox(dialogForm dialog)
        {
        ...
        public static OptionBox Show(string title, string label)
        {
            dialogForm dialog = new dialogForm(title, new InputBoxItem[] { new InputBoxItem(label) }, InputBoxButtons.OK);
            dialog.ShowDialog();
            return new OptionBox(dialog);
        }
        public static OptionBox Show(string title, string label, InputBoxButtons buttons)
        {
        ...
        public static OptionBox Show(string title, string label, string text)
        {
        ...
        public static OptionBox Show(string title, string label, string text, InputBoxButtons buttons)
        {
        ...
        public static OptionBox Show(string title, string[] labels)
        {
        ...
        public static OptionBox Show(string title, string[] labels, InputBoxButtons buttons)
        {
            InputBoxItem[] items = new InputBoxItem[labels.Length];
            for (int i = 0; i < labels.Length; i++)
            {
        ...
        public static OptionBox Show(string title, InputBoxItem item)
        {
        ...
        public static OptionBox Show(string title, InputBoxItem item, InputBoxButtons buttons)
        {
        ...
        public static OptionBox Show(string title, InputBoxItem[] items)
        {
            dialogForm dialog = new dialogForm(title, items, InputBoxButtons.OK);
            dialog.ShowDialog();
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(string title, InputBoxItem[] items, InputBoxButtons buttons)
        {
            dialogForm dialog = new dialogForm(title, items, buttons);
            dialog.ShowDialog();
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(IWin32Window window, string title, string label)
        {
            dialogForm dialog = new dialogForm(title, new InputBoxItem[] { new InputBoxItem(label) }, InputBoxButtons.OK);
        ...
        public static OptionBox Show(IWin32Window window, string title, string label, InputBoxButtons buttons)
        {
            dialogForm dialog = new dialogForm(title, new InputBoxItem[] { new InputBoxItem(label) }, buttons);
            dialog.ShowDialog(window);
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(IWin32Window window, string title, string label, string text)
        {
            dialogForm dialog = new dialogForm(title, new InputBoxItem[] { new InputBoxItem(label, text) }, InputBoxButtons.OK);
            dialog.ShowDialog(window);
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(IWin32Window window, string title, string label, string text, InputBoxButtons buttons)
        {
            dialogForm dialog = new dialogForm(title, new InputBoxItem[] { new InputBoxItem(label, text) }, buttons);
            dialog.ShowDialog(window);
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(IWin32Window window, string title, string[] labels)
        {
            InputBoxItem[] items = new InputBoxItem[labels.Length];
            for (int i = 0; i < labels.Length; i++)
            {
        ...
        public static OptionBox Show(IWin32Window window, string title, string[] labels, InputBoxButtons buttons)
        {
            InputBoxItem[] items = new InputBoxItem[labels.Length];
            for (int i = 0; i < labels.Length; i++)
            {
        ...
        public static OptionBox Show(IWin32Window window, string title, InputBoxItem item)
        {
            dialogForm dialog = new dialogForm(title, new InputBoxItem[] { item }, InputBoxButtons.OK);
            dialog.ShowDialog(window);
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(IWin32Window window, string title, InputBoxItem item, InputBoxButtons buttons)
        {
            dialogForm dialog = new dialogForm(title, new InputBoxItem[] { item }, buttons);
            dialog.ShowDialog(window);
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(IWin32Window window, string title, InputBoxItem[] items)
        {
            dialogForm dialog = new dialogForm(title, items, InputBoxButtons.OK);
            dialog.ShowDialog(window);
            return new OptionBox(dialog);
        ...
        public static OptionBox Show(IWin32Window window, string title, InputBoxItem[] items, InputBoxButtons buttons)
        {
            dialogForm dialog = new dialogForm(title, items, buttons);
            dialog.ShowDialog(window);
            return new OptionBox(dialog);
